    ...
    <footer class="g-bg-color--dark">
            ...
            <div class="container g-padding-y-80--xs">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-2 col-sm-5 col-sm-offset-1 s-footer__logo g-padding-y-50--xs g-padding-y-0--md">
                        <h3 class="g-font-size-18--xs g-color--white">Vision Statement</h3>
                        <p class="g-color--white-opacity">Our aim is to help as many people turn their dreams of owning an online business into a reality.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container g-padding-y-50--xs">
            <div class="row">
                <div class="col-xs-6">
                    <a href="index.html">
                        <img class="g-width-100--xs g-height-auto--xs" src="{{ URL::asset('img/logo.png') }}">
                    </a>
                </div>
