	...
	<div class="container mt-64 mb-64">
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
				<div class="well" style="padding: 36px;">
					<form action="/admin/posts/create" method="post" id="new_blog_post_form">
						...
						<div class="form-group">
							<input type="submit" name="submit_button" value="Create Draft" class="btn btn-primary">
							<input type="submit" name="submit_button" value="Create Post" class="btn btn-success">
						</div>
					</form>
				</div>
			</div>
