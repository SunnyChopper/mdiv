	...
	<div class="container mt-64 mb-64 mt-32-mobile mb-32-mobile">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12 col-12">
				<div class="gray-box">
					<h5 class="text-center mb-0">Performance Summary</h5>
					<p class="text-center"><small><b>Note:</b> These numbers are not valid. Still working on site analytics.</small></p>
					<hr />
					<div class="row mt-32">
						<div class="col-xs-4">
